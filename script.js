$(document).ready(function() {
  const apiRoot = 'https://tasks-prod-kodilla-tasks-wc1wgx.mo1.mogenius.io/v1/tasks';
  const trelloApiRoot = 'https://tasks-prod-kodilla-tasks-wc1wgx.mo1.mogenius.io/v1/trello';
